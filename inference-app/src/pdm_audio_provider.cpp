...
constexpr int kAudioCaptureBufferSize = INPUT_BUFFER_SIZE * 16;
...
void CaptureSamples() {
  ...
  const int number_of_samples = INPUT_BUFFER_SIZE;
  ...
  pdm_microphone_read(g_audio_capture_buffer + capture_index, INPUT_BUFFER_SIZE);
